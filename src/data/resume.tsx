...
export const DATA = {
  ...
  education: [
    ...
    {
      school: "Coursera (IBM)",
      href: "https://coursera.org/verify/specialization/1JYOZWGPUB3X",
      icon: GraduationCap,
      degree: "IBM DevOps, Cloud, and Agile Foundations Specialization",
      logoUrl: "",
      start: "Eylül 2025",
      end: "Eylül 2025",
    },
    {
      school: "Coursera (MathWorks)",
      href: "https://coursera.org/verify/77MHYZCODZKG",
      icon: GraduationCap,
      degree: "Introduction to Image Processing",
      logoUrl: "",
      start: "Eylül 2025",
      end: "Eylül 2025",
    },
    {
      school: "Coursera (MathWorks)",
      href: "https://coursera.org/verify/S6MMBSWJP6B0",
      icon: GraduationCap,
      degree: "Image Segmentation, Filtering, and Region Analysis",
      logoUrl: "",
      start: "Ekim 2025",
      end: "Ekim 2025",
    },
